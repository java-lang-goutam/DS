...
public class TwoArrayTriplet {
    ...
    public static void main(String[] args) {
        final int[] nums1 = {7, 4}, nums2 = {5, 2, 8, 9};
        System.out.println(new TwoArrayTriplet().numTriplets(nums1, nums2));
    }
}
